...
class EstimatedTimeOfArrival: NSManagedObject {
    ...
    convenience init(eta: NSDate, latitude: Double, longitude: Double, userName: String, homeSafe: Bool = false, id: String, context: NSManagedObjectContext = Stack.sharedStack.managedObjectContext) {
